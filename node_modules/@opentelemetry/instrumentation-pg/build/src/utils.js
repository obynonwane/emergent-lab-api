...
exports.patchCallbackPGPool = exports.patchCallback = exports.handleInvalidQuery = exports.handleTextQuery = exports.handleParameterizedQuery = exports.handleConfigQuery = exports.getJDBCString = void 0;
...
function pgStartSpan(tracer, client, name) {
    ...
    return tracer.startSpan(name, {
        ...
        attributes: {
            [enums_1.AttributeNames.COMPONENT]: pg_1.PgInstrumentation.COMPONENT,
            [enums_1.AttributeNames.DB_INSTANCE]: client.connectionParameters.database,
            [enums_1.AttributeNames.DB_TYPE]: pg_1.PgInstrumentation.DB_TYPE,
...
function handleConfigQuery(tracer, instrumentationConfig, queryConfig) {
    ...
    const name = pg_1.PgInstrumentation.BASE_SPAN_NAME + ':' + queryCommand;
...
function handleInvalidQuery(tracer, originalQuery, ...args) {
    let result;
    const span = pgStartSpan(tracer, this, pg_1.PgInstrumentation.BASE_SPAN_NAME);
    try {
