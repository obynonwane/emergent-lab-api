...
class GrpcNativeInstrumentation extends instrumentation_1.InstrumentationBase {
    ...
    _getInternalPatchs() {
        const onPatch = (moduleExports, version) => {
            ...
            this._wrap(moduleExports, 'makeClientConstructor', this._patchClient(grpcClient));
            return moduleExports;
        };
                    ...
                    return function func(call, callback) {
                        ...
                        api_1.context.with(api_1.propagation.extract(api_1.context.active(), call.metadata, {
                            ...
                            const span = instrumentation.tracer
                                ...
                                .setAttributes({
                                [enums_1.AttributeNames.GRPC_KIND]: spanOptions.kind,
                            });
                            api_1.context.with(api_1.setSpan(api_1.context.active(), span), () => {
                                switch (type) {
                                    case 'unary':
                                    case 'client_stream':
    ...
    _patchClient(grpcClient) {
        ...
        return (original) => {
            ...
            return function makeClientConstructor(methods, _serviceName, _options) {
                ...
                instrumentation._massWrap(client.prototype, instrumentation._getMethodsToWrap(client, methods), instrumentation._getPatchedClientMethods(grpcClient));
                return client;
            };
        };
    }
    ...
    _getPatchedClientMethods(grpcClient) {
        ...
        return (original) => {
            ...
            return function clientMethodTrace() {
                ...
                return api_1.context.with(api_1.setSpan(api_1.context.active(), span), () => clientUtils_1.makeGrpcClientRemoteCall(grpcClient, original, args, metadata, this)(span));
            };
        };
    }
}
