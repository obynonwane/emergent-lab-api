...
export declare type Dns = typeof dns;
...
export declare type LookupAllArgs = [dns.LookupAllOptions, (err: NodeJS.ErrnoException | null, addresses: dns.LookupAddress[]) => void];
export declare type LookupArgs = [dns.LookupOptions, (err: NodeJS.ErrnoException | null, address: string | dns.LookupAddress[], family: number) => void];
