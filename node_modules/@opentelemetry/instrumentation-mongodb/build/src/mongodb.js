...
class MongoDBInstrumentation extends instrumentation_1.InstrumentationBase {
    ...
    init() {
        ...
        return [
            new instrumentation_1.InstrumentationNodeModuleDefinition('mongodb', supportedVersions, undefined, undefined, [
    ...
    _getPatchOperation(operationName) {
        ...
        return (original) => {
            return function patchedServerCommand(server, ns, ops, options, callback) {
                ...
                instrumentation._populateAttributes(span, ns, server, 
