...
export declare class RedisInstrumentation extends InstrumentationBase<typeof redisTypes> {
    protected _config: RedisInstrumentationConfig;
    static readonly COMPONENT = "redis";
    constructor(_config?: RedisInstrumentationConfig);
    protected init(): InstrumentationNodeModuleDefinition<typeof redisTypes>[];
    /**
