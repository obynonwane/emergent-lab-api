        ...
        this._wrap(layer, 'handle', (original) => {
            ...
            return function (req, res) {
                ...
                const route = req[types_1._LAYERS_STORE_PROPERTY]
                    ...
                    .join('');
                const attributes = {
                    [semantic_conventions_1.SemanticAttributes.HTTP_ROUTE]: route.length > 0 ? route : undefined,
                };
                ...
                if (metadata.attributes[types_1.CustomAttributeNames.EXPRESS_TYPE] ===
                    types_1.ExpressLayerType.REQUEST_HANDLER) {
