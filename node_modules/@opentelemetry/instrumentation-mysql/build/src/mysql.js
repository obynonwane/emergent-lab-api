...
class MySQLInstrumentation extends instrumentation_1.InstrumentationBase {
    constructor(_config = {}) {
        super('@opentelemetry/instrumentation-mysql', version_1.VERSION, _config);
    ...
    _getConnectionCallbackPatchFn(cb, format) {
        ...
        return function () {
            if (arguments[1]) {
                ...
                // no need to unwrap
                if (!instrumentation_1.isWrapped(arguments[1].query)) {
                    thisPlugin._wrap(arguments[1], 'query', thisPlugin._patchQuery(arguments[1], format));
                }
            }
